# your_project_name/app/api/__init__.py
...
# --- your_project_name/app/api/routes.py ---
...
def get_resources():
    ...
    user_resources = Resource.query.filter_by(user_id=current_user.id).order_by(Resource.timestamp.desc()).all()
    resources_list = [
        {
            'id': r.id,
            'name': r.name,
